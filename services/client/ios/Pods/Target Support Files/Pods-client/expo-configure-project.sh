...
with_node \
  ...
  --target "/Users/datnguyentrong/Desktop/work_space/shikoku-mobile-app/services/client/ios/Pods/Target Support Files/Pods-client/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-secure-store" "expo-system-ui" "expo-web-browser"
